  ...
  return (
    <div className='product_info_container'>
      ...
      <div className='product_info_header'>
        <h3>
          <Link to='/'>Trang chủ</Link> &raquo; {product.name}
        </h3>
      </div>
          ...
          <div className='overall-info'>
            <div>
              ...
              <p>
                ...
                <br />
                <strong>Hãng sản xuất:</strong> {product.product?.overall?.brand}
                <br />
                <strong>Xuất xứ:</strong> {product.product?.overall?.made_in}
                <br />
                <strong>Chất liệu:</strong> {product.product?.overall?.material}
                <br />
                <strong>Màu sắc:</strong> {product.product?.overall?.color}
                <br />
              </p>
            ...
            <ol className='slogan'>
              ...
              <li>
                <img src='/assets/policy.png' alt='Bảo hành' /> CHÍNH SÁCH BẢO HÀNH VÀ ĐỔI TRẢ
              </li>
              <li>
                <img src='/assets/badge.png' alt='Chất lượng' /> CHẤT LƯỢNG ĐẢM BẢO
              </li>
            </ol>
          </div>
        </div>
